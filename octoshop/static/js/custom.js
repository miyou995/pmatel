    ...
    if ($('.price-ranger').length) {
        $('.price-ranger #slider-range').slider({
            ...
            slide: function(event, ui) {
                $('.price-ranger .ranger-min-max-block .min').val(ui.values[0] + 'DA');
                $('.price-ranger .ranger-min-max-block .max').val(ui.values[1] + 'DA');
            }
        });
        $('.price-ranger .ranger-min-max-block .min').val($('.price-ranger #slider-range').slider('values', 0) + 'DA');
        $('.price-ranger .ranger-min-max-block .max').val($('.price-ranger #slider-range').slider('values', 1) + 'DA');
    };
}
