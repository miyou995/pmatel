...
from .models import Business, Slide, ThreePhotos, Counter, LargeBanner ,  Partner,  ClientService
...
class LargeBannerAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'title', 'url', 'photo',image_tag)
    list_display_links = ('id',)
    list_editable = ['title', 'photo', 'url']
